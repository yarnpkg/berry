...
- The node-modules linker has received various improvements:
  - It now tolerates if node_modules is a symbolic link and does not recreate it
  - It now reinstalls modules that have their directories removed from node_modules by the user
