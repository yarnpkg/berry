...
import {Command as C, Binary as B, Path as P, Option as O, Value as V} from '@site/src/components/CommandLineHighlight2.tsx';
...
<C><B>corepack</B><P>enable</P><O>--install-directory</O><V>~/.volta/bin</V></C> # commandline-raw
```
