...
[^,2]: Or delegate to Yarn; did you know pnpm's [hoisted linker](https://pnpm.io/settings#nodelinker) is [uses Yarn as a dependency](https://github.com/pnpm/pnpm/blob/ee6e0734e911d48f6ff786aa0f05b9b9926e4815/pkg-manager/real-hoist/src/index.ts#L7)?
