...
import { Installer, BuildDirectiveTuple, BuildDirective } from './Installer';
...
export class Project {
  ...
  async linkEverything({cache, report}: InstallOptions) {
    ...
    const packageBuildDirectives: Map<LocatorHash, BuildDirectiveTuple[]> = new Map();
