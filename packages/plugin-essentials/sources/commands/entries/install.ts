...
export default class YarnCommand extends Command<CommandContext> {
  ...
  // Contrary to what you might expect, "yarn install" is the alias to "yarn",
  // rather than the other way around. This allows us to avoid setting a proxy
  // on the root of the CLI, which would mess with --version, --help, etc.
  async execute() {
