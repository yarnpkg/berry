import {Descriptor, Plugin, SettingsType, FormatType, Package} from '@yarnpkg/core';
...
export interface Hooks {
  ...
  fetchPackageInfo?: (
    pkg: Package,
    extra: Set<string>,
    registerData: (namespace: string, data: ReadonlyArray<[any, FormatType]> | {[key: string]: readonly [any, FormatType] | undefined}) => void,
  ) => Promise<void>,
}
