...
export class NodeModulesLinker implements Linker {
  ...
  async findPackageLocation(locator: Locator, opts: LinkOptions) {
    ...
    // Find the location with shallowest directory nesting that starts with cwd
    return sortedLocations.find(location => ppath.contains(startingCwd, location)) || locatorInfo.locations[0];
  }
