...
export const validateEditors = (editors: typeof SUPPORTED_EDITORS) => {
...
export const generateSdk = async (pnpApi: PnpApi, editors: typeof SUPPORTED_EDITORS | null, report: Report): Promise<void> => {
  ...
  if (allEditors.size === 0)
    throw new UsageError(`No editors have been provided as arguments and no existing editors could be found inside the editors.yml file. Make sure to use \`yarn pnpify --sdk=<editors>\` on non-pnpified projects`);
