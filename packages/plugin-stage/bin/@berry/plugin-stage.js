...
function findDriver(cwd) {
    ...
    if (driver === null || root === null)
        throw new concierge_1.UsageError(`No stage driver has been found for your current project`);
    return { driver, root };
}
/**
...
var Concierge = function () {
    function Concierge() {
        var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
            ...
            configKey = _ref$configKey === undefined ? 'config' : _ref$configKey;
    ...
    _createClass(Concierge, [{
        ...
        key: 'error',
        value: function error(_error, _ref2) {
        ...
        value: function usage(argv0) {
            ...
            var _ref3 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
                _ref3$command = _ref3.command,
                command = _ref3$command === undefined ? null : _ref3$command,
                _ref3$error = _ref3.error,
                error = _ref3$error === undefined ? null : _ref3$error,
                _ref3$stream = _ref3.stream,
                stream = _ref3$stream === undefined ? process.stderr : _ref3$stream;
            ...
            if (command) {
                ...
                if (!error) {
                    ...
                    if (command.description) {
                        ...
                        var capitalized = command.description.replace(/^[a-z]/, function ($0) {
                    ...
                    if (command.details || command.examples.length > 0) {
                        ...
                        stream.write(_chalk2.default.bold('Usage:') + '\n');
                        stream.write('\n');
                        stream.write(((argv0 || '') + ' ' + commandPath + ' ' + requiredArguments + ' ' + optionalArguments + ' ' + commandOptions + '\n').replace(/ +/g, ' ').replace(/^ +| +$/g, ''));
                    } else {

                        stream.write((_chalk2.default.bold('Usage:') + ' ' + (argv0 || '') + ' ' + commandPath + ' ' + requiredArguments + ' ' + optionalArguments + ' ' + commandOptions + '\n').replace(/ +/g, ' ').replace(/^ +| +$/g, ''));
                    }

                    if (command.details) {

                        stream.write('\n');
                        stream.write(_chalk2.default.bold('Details:') + '\n');
                        stream.write('\n');
                    ...
                    if (command.examples.length > 0) {
                        ...
                        stream.write('\n');
                        stream.write(_chalk2.default.bold('Examples:') + '\n');
                        ...
                        try {
                            for (var _iterator5 = command.examples[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                                var _ref4 = _step5.value;
                                var description = _ref4.description,
                                    example = _ref4.example;
                ...
                (function () {
                    ...
                    var globalOptions = getOptionString(_this.options);

                    stream.write((_chalk2.default.bold('Usage:') + ' ' + (argv0 || '<binary>') + ' ' + globalOptions + ' <command>\n').replace(/ +/g, ' ').replace(/ +$/, ''));

                    var commandsByCategories = new Map();
                    var maxPathLength = 0;
                    ...
                    try {
                        for (var _iterator6 = _this.commands[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                            var _command = _step6.value;


                            if (_command.hiddenCommand || _command.path.some(function (component) {
                                return component.startsWith('_');
                            })) continue;

                            var categoryCommands = commandsByCategories.get(_command.category);

                            if (!categoryCommands) commandsByCategories.set(_command.category, categoryCommands = []);

                            categoryCommands.push(_command);

                            var thisPathLength = _command.path.join(' ').length;
                    ...
                    var categoryNames = Array.from(commandsByCategories.keys()).sort(function (a, b) {
                    ...
                    try {
                        for (var _iterator7 = categoryNames[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
                            var categoryName = _step7.value;


                            var commands = commandsByCategories.get(categoryName).slice().sort(function (a, b) {
                            ...
                            var header = categoryName !== null ? categoryName.trim() : 'Where <command> is one of';

                            stream.write('\n');
                            stream.write(_chalk2.default.bold(header + ':') + '\n');
                            stream.write('\n');
                            ...
                            try {
                                for (var _iterator8 = commands[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
                                    var _command2 = _step8.value;

                                    stream.write('  ' + _chalk2.default.bold(pad(_command2.path.join(' '))) + '  ' + (_command2.description ? _command2.description.trim() : 'undocumented') + '\n');
                                }
                            } catch (err) {
        ...
        value: function check() {
            ...
            if (this.validator && !this.Joi) throw new Error('Validators cannot be used unless Joi has been setup');
            ...
            try {
                for (var _iterator9 = this.commands[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
        ...
        value: function run(argv0, argv) {
            ...
            var _ref5$stdin = _ref5.stdin,
                stdin = _ref5$stdin === undefined ? process.stdin : _ref5$stdin,
                _ref5$stdout = _ref5.stdout,
                stdout = _ref5$stdout === undefined ? process.stdout : _ref5$stdout,
                _ref5$stderr = _ref5.stderr,
                stderr = _ref5$stderr === undefined ? process.stderr : _ref5$stderr,
                initialEnv = _objectWithoutProperties(_ref5, ['stdin', 'stdout', 'stderr']);

            // Sanity check to make sure that the configuration makes sense
            this.check();

            // This object is the one we'll fill with the parsed options
            var env = _extends({ argv0: argv0, stdin: stdin, stdout: stdout, stderr: stderr }, initialEnv);
            ...
            try {
                        ...
                        case SHORT_OPTION:
                            {
                                ...
                                if (leadingOption) lockCommand();else leadingOption = _this2.options.find(function (option) {
                                    return option.shortName === current.leading;
                                });
                                ...
                                if (leadingOption.argumentName) {
                                    ...
                                    var _loop3 = function _loop3(_optionName) {
                                        ...
                                        if (option) lockCommand();else option = _this2.options.find(function (option) {
                                            return option.shortName === _optionName;
                                        });
                        ...
                        case LONG_OPTION:
                            {
                                ...
                                if (_option3) lockCommand();else _option3 = _this2.options.find(function (option) {
                                    return option.longName === current.name;
                                });
                ...
                try {
                    for (var _iterator11 = selectedCommand.requiredArguments[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
                ...
                try {
                    for (var _iterator12 = selectedCommand.optionalArguments[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
                ...
                if (this.validator || selectedCommand.validator) {
                    ...
                    var validationResults = this.Joi.validate(env, validator);
                ...
                if (env.help) {
                    ...
                    if (this.hasConfig && env.config) {
                        ...
                        try {
                            for (var _iterator13 = Object.keys(configOptions)[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
        ...
        value: function runExit(argv0, argv) {
            ...
            var _ref6$stdin = _ref6.stdin,
                stdin = _ref6$stdin === undefined ? process.stdin : _ref6$stdin,
                _ref6$stdout = _ref6.stdout,
                stdout = _ref6$stdout === undefined ? process.stdout : _ref6$stdout,
                _ref6$stderr = _ref6.stderr,
                stderr = _ref6$stderr === undefined ? process.stderr : _ref6$stderr,
                rest = _objectWithoutProperties(_ref6, ['stdin', 'stdout', 'stderr']);

            return Promise.resolve(this.run(argv0, argv, _extends({ stdin: stdin, stdout: stdout, stderr: stderr }, rest))).then(function (exitCode) {

                process.exitCode = exitCode;
            }, function (error) {

                _this3.error(error, { stream: stderr });
...
function extractContent(text, paragraphs) {
    ...
    if (paragraphs) {
        text = text.split(/\r\n|\r|\n/g).map(function (paragraph) {
            ...
            var bulletMatch = paragraph.match(/^[*-][\t ]+(.*)/);

            if (bulletMatch) {
                return bulletMatch[1].match(/(.{1,78})(?: |$)/g).map(function (line, index) {
                    return (index === 0 ? '- ' : '  ') + line;
                }).join('\n');
            } else {
    ...
    text = text.replace(/(`+)((?:.|[\n])*?)\1/g, function ($0, $1, $2) {
        return _chalk2.default.cyan($1 + $2 + $1);
    });
...
var Command = function () {
    ...
    _createClass(Command, [{
        ...
        key: 'categorize',
        value: function categorize(category) {
        ...
        key: 'example',
        value: function example(description, _example) {

            this.examples.push({
                description: extractContent(description, true),
                example: extractContent(_example, false)
            });
...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
    ...
    return [Object.assign({}, names, { argumentName: argumentName, initialValue: undefined })];
      ...
      peg$c33 = function peg$c33(names) {
    return [Object.assign({}, names, { argumentName: null, initialValue: null })];
  },
      peg$c34 = function peg$c34(names) {
    return [Object.assign({}, names, { argumentName: null })];
      ...
      peg$c39 = function peg$c39(shortName) {
    return text();
  },
      peg$c40 = function peg$c40(shortName, repeat) {
    return repeat;
  },
      peg$c41 = ",--",
      peg$c42 = peg$literalExpectation(",--", false),
      peg$c43 = function peg$c43(shortName, repeats, longName) {
    return longName;
  },
      peg$c44 = function peg$c44(shortName, repeats, longName) {
    return repeats.every(function (repeat, index) {
      return repeat === shortName.shortName.repeat(2 + index);
    });
  },
      peg$c45 = function peg$c45(shortName, repeats, longName) {
    return Object.assign({}, shortName, longName, { initialValue: 0, maxValue: 1 + repeats.length });
  },
      peg$c46 = function peg$c46(shortName, longName) {
    return Object.assign({}, shortName, longName);
  },
      peg$c47 = function peg$c47(shortName) {
    return Object.assign({}, shortName, { longName: null });
  },
      peg$c48 = "--",
      peg$c49 = peg$literalExpectation("--", false),
      peg$c50 = function peg$c50(longName) {
    return Object.assign({}, longName, { shortName: null });
  },
      peg$c51 = /^[a-zA-Z]/,
      peg$c52 = peg$classExpectation([["a", "z"], ["A", "Z"]], false, false),
      peg$c53 = function peg$c53(shortName) {
    ...
    return { longName: longName, initialValue: true };
      ...
      peg$c59 = function peg$c59(longName) {
    return { longName: "with-" + longName, initialValue: true };
  },
      peg$c60 = function peg$c60(longName) {
...
function filterChanges(cwd, yarnRoots, yarnNames) {
    const changelist = [];
    const buffer = child_process_1.execFileSync(`git`, [`status`, `-s`], { cwd });
...
function makeCommit(cwd, changeList) {
    child_process_1.execFileSync(`git`, [`add`, `-N`, `--`, ...changeList], { cwd });
    child_process_1.execFileSync(`git`, [`commit`, `-m`, `${genCommitMessage(cwd)}\n\n${MESSAGE_MARKER}\n`, `--`, ...changeList], { cwd });
}
function makeReset(cwd, changeList) {
    child_process_1.execFileSync(`git`, [`reset`, `HEAD`, `--`, ...changeList], { cwd });
}
function genCommitMessage(cwd) {
    const buffer = child_process_1.execFileSync(`git`, [`log`, `-${COMMIT_DEPTH}`, `--pretty=format:%s`], { cwd });
    const lines = buffer.toString().split(/\n/g).filter(line => line !== ``);
...
function filterChanges(cwd, paths, filenames) {
    return [];
}
function makeCommit(cwd, changeList) {
}
...
function makeUpdate(cwd, changeList) {
}
exports.Driver = {
    findRoot,
    filterChanges,
