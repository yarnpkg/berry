...
import {CreateReadStreamOptions, CreateWriteStreamOptions, FakeFS, ExtractHintOptions, WatchFileCallback, WatchFileOptions, StatWatcher, Dir, OpendirOptions, ReaddirOptions} from './FakeFS';
...
export abstract class ProxiedFS<P extends Path, IP extends Path> extends FakeFS<P> {
  ...
  async readdirPromise(p: P, opts: {recursive?: false, withFileTypes: true}): Promise<Array<Dirent>>;
  async readdirPromise(p: P, opts: {recursive?: false, withFileTypes?: false}): Promise<Array<Filename>>;
  async readdirPromise(p: P, opts: {recursive?: false, withFileTypes: boolean}): Promise<Array<Dirent<P> | Filename>>;
  ...
  async readdirPromise(p: P, opts: {recursive: true, withFileTypes: boolean}): Promise<Array<Dirent | P>>;
  async readdirPromise(p: P, opts: {recursive: boolean, withFileTypes: true}): Promise<Array<Dirent<P>>>;
  async readdirPromise(p: P, opts: {recursive: boolean, withFileTypes?: false}): Promise<Array<P>>;
  async readdirPromise(p: P, opts: {recursive: boolean, withFileTypes: boolean}): Promise<Array<Dirent<P> | P>>;
  async readdirPromise(p: P, opts?: ReaddirOptions | null): Promise<Array<Dirent<P> | Dirent | P | Filename>> {
    return this.baseFs.readdirPromise(this.mapToBase(p), opts as any);
  }

  readdirSync(p: P, opts?: null): Array<Filename>;
  readdirSync(p: P, opts: {recursive?: false, withFileTypes: true}): Array<Dirent>;
  readdirSync(p: P, opts: {recursive?: false, withFileTypes?: false}): Array<Filename>;
  readdirSync(p: P, opts: {recursive?: false, withFileTypes: boolean}): Array<Dirent | Filename>;
  ...
  readdirSync(p: P, opts: {recursive: true, withFileTypes: boolean}): Array<Dirent | P>;
  readdirSync(p: P, opts: {recursive: boolean, withFileTypes: true}): Array<Dirent<P>>;
  readdirSync(p: P, opts: {recursive: boolean, withFileTypes?: false}): Array<P>;
  readdirSync(p: P, opts: {recursive: boolean, withFileTypes: boolean}): Array<Dirent<P> | P>;
  readdirSync(p: P, opts?: ReaddirOptions | null): Array<Dirent<P> | Dirent | P | Filename> {
