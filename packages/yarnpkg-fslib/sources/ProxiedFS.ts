...
export abstract class ProxiedFS<P extends Path, IP extends Path> extends FakeFS<P> {
  ...
  readdirPromise(p: P, opts: {recursive?: false, withFileTypes: true}): Promise<Array<Dirent<P>>>;
  readdirPromise(p: P, opts: {recursive?: false, withFileTypes?: false}): Promise<Array<Filename>>;
  readdirPromise(p: P, opts: {recursive?: false, withFileTypes: boolean}): Promise<Array<Dirent<P> | Filename>>;
  ...
  readdirPromise(p: P, opts: {recursive: boolean, withFileTypes: true}): Promise<Array<Dirent<P>>>;
  readdirPromise(p: P, opts: {recursive: boolean, withFileTypes?: false}): Promise<Array<P>>;
  readdirPromise(p: P, opts: {recursive: boolean, withFileTypes: boolean}): Promise<Array<Dirent<P> | P>>;
  readdirPromise(p: P, opts?: ReaddirOptions | null): Promise<Array<Dirent<P> | P | Filename>> {
    return this.baseFs.readdirPromise(this.mapToBase(p), opts as any);
  }

  readdirSync(p: P, opts?: null): Array<Filename>;
  readdirSync(p: P, opts: {recursive?: false, withFileTypes: true}): Array<Dirent<P>>;
  readdirSync(p: P, opts: {recursive?: false, withFileTypes?: false}): Array<Filename>;
  readdirSync(p: P, opts: {recursive?: false, withFileTypes: boolean}): Array<Dirent<P> | Filename>;
  ...
  readdirSync(p: P, opts?: ReaddirOptions | null): Array<Dirent<P> | P | Filename> {
