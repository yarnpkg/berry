        ...
        if (opts.recursive && process.platform === `win32`) {
          if (opts.withFileTypes) {
            this.realFs.readdir(
              npath.fromPortablePath(p),
              opts as any,
              this.makeCallback<Array<Dirent<NativePath>>>(
            ...
            this.realFs.readdir(
              npath.fromPortablePath(p),
              opts as any,
              this.makeCallback<Array<NativePath>>(
  ...
  readdirSync(
    ...
    if (opts) {
      if (opts.recursive && process.platform === `win32`) {
        if (opts.withFileTypes) {
          return (
            this.realFs.readdirSync(npath.fromPortablePath(p), opts as any) as any as Array<Dirent<NativePath>>
          ).map(direntToPortable);
        } else {
          return (this.realFs.readdirSync(npath.fromPortablePath(p), opts as any) as any as Array<NativePath>).map(
