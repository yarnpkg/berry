...
Object.defineProperty(exports, "__esModule", { value: true });
const NodeFS_1 = __webpack_require__(5);
var AliasFS_1 = __webpack_require__(8);
exports.AliasFS = AliasFS_1.AliasFS;
var FakeFS_1 = __webpack_require__(2);
...
Object.defineProperty(exports, "__esModule", { value: true });
const fs_1 = __importDefault(__webpack_require__(0));
const path_1 = __webpack_require__(3);
const FakeFS_1 = __webpack_require__(2);
...
const FakeFS_1 = __webpack_require__(2);
const NodeFS_1 = __webpack_require__(5);
const ZipFS_1 = __webpack_require__(6);
...
// EXTERNAL MODULE: ../berry-fslib/lib/index.js
...
var dynamicRequire = __webpack_require__(1);
...
class NodeModulesFS_NodeModulesFS extends lib["FakeFS"] {
    constructor({ baseFs = new lib["PosixFS"](new lib["NodeFS"]()) } = {}) {
        super();
        this.baseFs = baseFs;
...
const patchFs = () => {
    if (!fsPatched) {
        ...
        const baseFs = new lib["PosixFS"](new lib["NodeFS"](localFs));
        const nodeModulesFS = new NodeModulesFS_NodeModulesFS({ baseFs });
        Object(lib["patchFs"])(external_fs_default.a, nodeModulesFS);
        fsPatched = true;
    }
};
