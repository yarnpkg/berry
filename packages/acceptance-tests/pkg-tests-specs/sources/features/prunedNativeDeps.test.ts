...
describe(`Features`, () => {
  describe(`Pruned native deps`, () => {
    ...
    it(
      `shouldn't fetch packages that it won't need`,
      makeTemporaryEnv(
        {
          dependencies: {
            [`optional-native`]: `1.0.0`,
        ...
        async ({ path, run, source }) => {
          ...
          const tarballRequests = recording
            .filter((request) => {
    ...
    it(
      `should overfetch if requested to do so`,
      makeTemporaryEnv(
        {
          dependencies: {
            [`optional-native`]: `1.0.0`,
    ...
    it(
      `should produce a stable lockfile, regardless of the architecture`,
      makeTemporaryEnv(
        {
          dependencies: {
            [`optional-native`]: `1.0.0`,
    ...
    it(
      `should produce a stable PnP hook, regardless of the architecture`,
      makeTemporaryEnv(
        {
          dependencies: {
            [`optional-native`]: `1.0.0`,
    ...
    it(
      `shouldn't break when using --check-cache with native packages`,
      makeTemporaryEnv(
        {
          dependencies: {
            [`optional-native`]: `1.0.0`,
    ...
    it(
      `should detect packages being tampered when using --check-cache`,
      makeTemporaryEnv(
        {
          dependencies: {
            [`optional-native`]: `1.0.0`,
    ...
    it(
      `should also validate other architectures than the current one if necessary when using --check-cache`,
      makeTemporaryEnv(
        {
          dependencies: {
            [`optional-native`]: `1.0.0`,
    ...
    it(
      `should only fetch other architectures when using --check-cache if they are already in the cache`,
      makeTemporaryEnv(
        {
          dependencies: {
            [`optional-native`]: `1.0.0`,
