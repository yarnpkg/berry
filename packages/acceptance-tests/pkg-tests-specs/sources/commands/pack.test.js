  ...
  describe(`pack`, () => {
    ...
    test(
      ...
      makeTemporaryEnv({}, async ({ path, run, source }) => {
        ...
        await expect(genPackList(run)).resolves.toEqual([`foo/y.js`, `package.json`, `y.js`]);
      }),
    );
    ...
    test(
      ...
      makeTemporaryEnv({}, async ({ path, run, source }) => {
        ...
        await expect(genPackList(run)).resolves.toEqual([`foo/x.js`, `package.json`, `x.js`]);
      }),
    );
    ...
    test(
      ...
      makeTemporaryEnv({}, async ({ path, run, source }) => {
        ...
        await expect(genPackList(run)).resolves.toEqual([`package.json`, `x.js`]);
      }),
    );
    ...
    test(
      ...
      makeTemporaryEnv({}, async ({ path, run, source }) => {
        ...
        await expect(genPackList(run)).resolves.toEqual([`foo/bar/x.js`, `foo/x.js`, `package.json`, `x.js`]);
      }),
    );
