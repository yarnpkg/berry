...
describe(`Entry`, () => {
  ...
  describe(`--cwd`, () => {
    test(
      `should use the specified --cwd (relative path)`,
      makeTemporaryEnv({}, async ({ path, run, source }) => {
        await run(`install`);
    ...
    test(
      `should use the specified --cwd (absolute path)`,
      makeTemporaryEnv({}, async ({ path, run, source }) => {
        await run(`install`);
    ...
    test(
      `should use the specified --cwd (relative symlink)`,
      makeTemporaryEnv({}, async ({ path, run, source }) => {
        await run(`install`);
    ...
    test(
      `should use the specified --cwd (absolute symlink)`,
      makeTemporaryEnv({}, async ({ path, run, source }) => {
        await run(`install`);
    ...
    test(
      `should use the specified --cwd (bound relative path)`,
      makeTemporaryEnv({}, async ({ path, run, source }) => {
        await run(`install`);
    ...
    test(
      `should use the specified --cwd (bound absolute path)`,
      makeTemporaryEnv({}, async ({ path, run, source }) => {
        await run(`install`);
    ...
    test(
      `should use the specified --cwd (inside script)`,
      makeTemporaryEnv(
        {
          scripts: {
