    ...
    test(
      ...
      makeTemporaryEnv(
        ...
        async ({ path, run, source }) => {
          ...
          await expect(xfs.readJsonPromise(`${path}/package.json`)).resolves.not.toHaveProperty(
            `devDependencies.no-deps`,
          );
        },
      ),
    );
    ...
    test(
      ...
      makeTemporaryEnv(
        ...
        async ({ path, run, source }) => {
          ...
          await expect(xfs.readJsonPromise(`${path}/package.json`)).resolves.toHaveProperty(
            `dependencies.one-fixed-dep`,
          );
        },
      ),
    );
    ...
    test(
      ...
      makeTemporaryEnv(
        ...
        async ({ path, run, source }) => {
          ...
          await expect(xfs.readJsonPromise(`${path}/packages/workspace-a/package.json`)).resolves.not.toHaveProperty(
            `dependencies`,
          );
          await expect(xfs.readJsonPromise(`${path}/packages/workspace-b/package.json`)).resolves.not.toHaveProperty(
            `dependencies`,
          );
          await expect(xfs.readJsonPromise(`${path}/packages/workspace-c/package.json`)).resolves.not.toHaveProperty(
            `dependencies`,
          );
        },
      ),
