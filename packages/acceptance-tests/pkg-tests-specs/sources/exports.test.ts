...
export async function writeTestPackage(path: PortablePath, manifest: Manifest, files: Array<string>) {
  ...
  await Promise.all(
    (files as Array<PortablePath>).map(async (file) => {
...
export function makeTemporaryExportsEnv(
  testPackageName: string,
  manifest: Omit<Manifest, "name">,
  files: Array<string>,
  ...
  return makeTemporaryEnv(
    ...
    async ({ path, run, source }) => {
      await writeTestPackage(
        `${path}/${testPackageName}` as PortablePath,
        {
      ...
      const getPathRelativeToPackageRoot = (filename: NativePath) => {
        ...
        if (match === null) throw new Error(`Assertion failed: Expected the match to be successful`);

        return match[1] as PortablePath;
      };

      const sourceRequest = (request: string) =>
        source(makeScript(interpolateVariables(request))).then((p) => getPathRelativeToPackageRoot(p as any));
...
describe(`"exports" field`, () => {
  test(
    `implicit "main" field`,
    makeTemporaryExportsEnv(`main-implicit`, {}, [`index.js`, `index.mjs`, `file.js`], {
      pass: [
        [`$PKG`, `index.js`],
        [`$PKG/file`, `file.js`],
      ],
    ...
    makeTemporaryExportsEnv(
      ...
      [`index.js`, `index.mjs`, `file.js`],
      {
        ...
        fail: [
          [
            `$PKG/index`,
            { message: `Package subpath './index' is not defined`, code: `ERR_PACKAGE_PATH_NOT_EXPORTED` },
          ],
        ],
      },
    ),
  ...
  test(
    ...
    makeTemporaryExportsEnv(
      ...
      [`index.js`, `index.mjs`, `main.js`, `file.js`],
      {
        pass: [[`$PKG`, `file.js`]],
        fail: [
  ...
  test(
    ...
    makeTemporaryExportsEnv(
      ...
      [`index.js`, `index.mjs`, `import.mjs`, `node.js`, `require.js`, `default.js`],
      {
        pass: [[`$PKG`, `node.js`]],
        fail: [
          [
          ...
          [
            `$PKG/import`,
            { message: `Package subpath './import' is not defined`, code: `ERR_PACKAGE_PATH_NOT_EXPORTED` },
          ],
          [`$PKG/node`, { message: `Package subpath './node' is not defined`, code: `ERR_PACKAGE_PATH_NOT_EXPORTED` }],
          [
            `$PKG/default`,
            { message: `Package subpath './default' is not defined`, code: `ERR_PACKAGE_PATH_NOT_EXPORTED` },
          ],
        ],
      },
    ),
  ...
  test(
    ...
    makeTemporaryExportsEnv(
      ...
      [`index.js`, `index.mjs`, `main.js`, `import.mjs`, `node.js`, `require.js`, `default.js`],
      {
        pass: [[`$PKG`, `node.js`]],
        fail: [
          [
  ...
  test(
    ...
    makeTemporaryExportsEnv(
      `exports-top-level-object`,
      {
        exports: [{ import: `./import.mjs` }, `./default.js`],
      },
      [`index.js`, `index.mjs`, `import.mjs`, `default.js`],
      {
        pass: [[`$PKG`, `default.js`]],
        fail: [
          [
  ...
  test(
    ...
    makeTemporaryExportsEnv(
      ...
      [`index.js`, `index.mjs`, `main.js`, `import.mjs`, `default.js`],
      {
        pass: [[`$PKG`, `default.js`]],
        fail: [
          [
  ...
  test(
    ...
    makeTemporaryExportsEnv(
      ...
      [`index.js`, `index.mjs`, `file.js`, `lib/submodule.js`],
      {
        pass: [
          [`$PKG`, `file.js`],
        ...
        fail: [
          ...
          [
            `$PKG/inexistent`,
            { message: `Package subpath './inexistent' is not defined`, code: `ERR_PACKAGE_PATH_NOT_EXPORTED` },
          ],
        ],
      },
    ),
  ...
  test(
    ...
    makeTemporaryExportsEnv(
      ...
      [`index.js`, `index.mjs`, `main.js`, `file.js`, `lib/submodule.js`],
      {
        pass: [
          [`$PKG`, `file.js`],
          [`$PKG/submodule`, `lib/submodule.js`],
  ...
  test(
    ...
    makeTemporaryExportsEnv(
      `exports-object-subpath-patterns`,
      {
        exports: {
          [`.`]: `./file.js`,
          [`./src/*`]: `./lib/*`,
      ...
      [`index.js`, `index.mjs`, `file.js`, `lib/a.js`, `lib/b.js`, `lib/c.js`],
      {
        pass: [
          [`$PKG`, `file.js`],
          [`$PKG/src/a`, `lib/a.js`],
        ...
        fail: [
          ...
          [
            `$PKG/lib/c`,
            { message: `Package subpath './lib/c' is not defined`, code: `ERR_PACKAGE_PATH_NOT_EXPORTED` },
          ],
          [
            `$PKG/src/d`,
            {
  ...
  test(
    ...
    makeTemporaryExportsEnv(
      `main-exports-object-subpath-patterns`,
      {
        main: `main.js`,
        exports: {
          [`.`]: `./file.js`,
      ...
      [`index.js`, `index.mjs`, `main.js`, `file.js`, `lib/a.js`, `lib/b.js`, `lib/c.js`],
      {
        pass: [
          [`$PKG`, `file.js`],
          [`$PKG/src/a`, `lib/a.js`],
  ...
  test(
    ...
    makeTemporaryExportsEnv(
      `exports-top-level-object-only-import`,
      {
        exports: {
          node: {
      ...
      [`index.js`, `index.mjs`, `import.mjs`, `node-import.mjs`],
      {
        fail: [[`$PKG`, { message: `No "exports" main defined`, code: `ERR_PACKAGE_PATH_NOT_EXPORTED` }]],
      },
    ),
  );
  ...
  test(
    ...
    makeTemporaryExportsEnv(
      `main-exports-top-level-object-only-import`,
      {
        main: `main.js`,
        exports: {
          node: {
      ...
      [`index.js`, `index.mjs`, `main.js`, `import.mjs`, `node-import.mjs`],
      {
        fail: [[`$PKG`, { message: `No "exports" main defined`, code: `ERR_PACKAGE_PATH_NOT_EXPORTED` }]],
      },
    ),
    ...
    makeTemporaryExportsEnv(
      ...
      [`index.js`, `index.mjs`, `file.js`],
      {
        fail: [
          [
            `$PKG/package.json`,
            { message: `Package subpath './package.json' is not defined`, code: `ERR_PACKAGE_PATH_NOT_EXPORTED` },
          ],
        ],
      },
    ),
  ...
  test(
    ...
    makeTemporaryEnv(
      ...
      async ({ path, run, source }) => {
        ...
        await expect(source(`require.resolve('pkg')`)).resolves.toStrictEqual(
          npath.fromPortablePath(`${path}/main.js`),
        );
        await expect(source(`require.resolve('pkg/foo')`)).resolves.toStrictEqual(
          npath.fromPortablePath(`${path}/bar.js`),
        );
  ...
  test(
    ...
    makeTemporaryEnv({}, async ({ path, run, source }) => {
      ...
      await expect(source(`require.resolve('linked')`)).resolves.toStrictEqual(
        npath.fromPortablePath(`${path}/linked/main.js`),
      );
      await expect(source(`require.resolve('linked/foo')`)).resolves.toStrictEqual(
        npath.fromPortablePath(`${path}/linked/bar.js`),
      );
    }),
  );
  ...
  test(
    ...
    makeTemporaryEnv({}, async ({ path, run, source }) => {
      ...
      await expect(source(`require.resolve('linked')`)).resolves.toStrictEqual(
        npath.fromPortablePath(`${tmp}/main.js`),
      );
      await expect(source(`require.resolve('linked/foo')`)).resolves.toStrictEqual(
        npath.fromPortablePath(`${tmp}/bar.js`),
      );
    }),
  );
    ...
    makeTemporaryEnv(
      ...
      async ({ path, run, source }) => {
        ...
        await xfs.writeFilePromise(
          `${path}/foo/node-resolution.js` as PortablePath,
          `module.exports = require.resolve('dep');\n`,
        );

        await expect(source(`require('./foo/node-resolution')`)).resolves.toStrictEqual(
          npath.fromPortablePath(`${path}/node_modules/dep/main.js`),
        );
      },
    ),
  );
  ...
  test(`pnpIgnorePatterns with exports (subpath ignored)`, async () => {
    expect(require.resolve(`@yarnpkg/monorepo/.yarn/sdks/typescript/lib/tsserver.js`)).toStrictEqual(
      npath.join(__dirname, `../../../../.yarn/sdks/typescript/lib/tsserver.js`),
    );
  });
  ...
  test(
    ...
    makeTemporaryEnv(
      ...
      async ({ path, run, source }) => {
        ...
        await expect(source(`require.resolve('pnpapi')`)).resolves.toStrictEqual(
          npath.fromPortablePath(`${path}/.pnp.cjs`),
        );

        await expect(source(`require('pnpapi').resolveToUnqualified('pnpapi', null)`)).resolves.toStrictEqual(
          npath.fromPortablePath(`${path}/.pnp.cjs`),
        );
        await expect(source(`require('pnpapi').resolveRequest('pnpapi', null)`)).resolves.toStrictEqual(
          npath.fromPortablePath(`${path}/.pnp.cjs`),
        );
      },
    ),
