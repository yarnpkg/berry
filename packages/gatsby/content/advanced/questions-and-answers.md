...
Most commonly, the following patterns should be ignored:
...
# Include to skip downloading packages when running an install:
!.yarn/cache
.pnp.*
...
### Ignore when not using Zero Installs:
