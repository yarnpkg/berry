...
5. Add [`nodeLinker: node-modules`](/configuration/yarnrc#nodeLinker) in your [`.yarnrc.yml`](https://yarnpkg.com/configuration/yarnrc) file at the root level of your project.
