...
export const convertSchemaToConfiguration = (schema: JSONSchema7, {mode}: {mode: SchemaMode}) => {
  ...
  const schemaLink = combinedSchema.__info.join().match(/https?.+\.json/g);

  return (
    <Container>
      <Main>
        {renderMarkdown(`This documentation is auto-generated by its JSON schema, [available here](${schemaLink}).`)}
      </Main>
      <Main>
