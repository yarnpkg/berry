...
export class Project {
  ...
  async restoreInstallState() {
    ...
    const parsed= parseSyml(content) as {accessibleLocators:LocatorHash[],optionalBuilds:LocatorHash[],storedDescriptors:{[key:string]:Descriptor},storedResolutions:{[key:string]:LocatorHash},storedPackages:{[key:string]:Package}} ;
